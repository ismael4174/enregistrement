...
<button type="button" class="btn btn-primary" style="text-align: center;"><a href="<?php echo e(url('/liste')); ?>" target="_blank" style="color: antiquewhite">Voir la liste d'enregistrement</a></button>
  </form>
...
<?php /**PATH C:\wamp64\www\enregistrement\resources\views/enregistrement.blade.php ENDPATH**/ ?>